(() => {
  ...
  function formatSeconds(seconds) {
    ...
    if (n < 0.01 && n > 0) return `${Math.round(n * 1000)}ms`;
  ...
  function formatterFor(input) {
    ...
    switch (name) {
      ...
      case "convolutionPreset": return (v) => v <= 0 ? "Off" : String(Math.round(v));
  ...
  const sharedWetDryIds = [
    "app2_b2_p1_bitCrushPresetWet",
    "app2_b2_p2_saturationPresetWet",
    "app2_b2_p3_widthPresetWet",
    "app2_b2_p4_detunePresetWet",
    "app2_b2_p5_chorusPresetWet",
    "app2_b2_p6_delayPresetWet",
    "app2_b2_p7_reverbPresetWet",
  ];
