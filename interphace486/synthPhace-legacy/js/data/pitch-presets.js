...
(function () {
  ...
  const presets = [
    ...
    P("Clean Vinyl", "Init reference with tonal voices muted for clean vinyl texture and needle-drop audition", { synth:{fm:fm(0,0,1,"sine",0,2,"sine",0,0,0,0,0,0)}, texture:{preset:3,amount:10}, transient:{preset:7,volume:45} }),
